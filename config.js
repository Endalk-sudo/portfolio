...
window.SITE = {
    ...
    projects: [
        ...
        },
        {
            ...
            year: '2026',
            status: 'stable',
            blurb: 'Local-first English vocab app with SM-2 spaced repetition',
            outcome: 'Retain TOEFL/IELTS vocab long-term — offline, private, no account needed',
            desc: 'LexiLearn is a 100% local, offline-capable vocabulary trainer. SQLite + Prisma backend, Next.js 16 frontend with Learn → Reveal → Spell flow, SM-2 review scheduling (Again/Hard/Good/Easy), 5 quiz modes, XP/levels/streaks, Recharts stats + contribution heatmap, browser TTS pronunciation, Amharic translations, and an optional local Ollama AI Mentor for writing/conversation practice.',
            stack: ['typescript', 'nextjs', 'react', 'tailwind', 'prisma', 'sqlite', 'zustand', 'ollama'],
            url: '',
            repo: 'https://github.com/Endalk-sudo/lexilearn',
            sourceNote: 'Open source — available on GitHub',
            highlights: [
                'SM-2 spaced repetition with mastery tracking',
                '100% offline SQLite — no telemetry or accounts',
                '5 quiz modes + XP/levels/streaks + analytics',
        ...
        },
        {
            ...
            stack: ['python', 'telegram-bot', 'gemini', 'supabase', 'pydantic', 'httpx', 'railway', 'cbe-pay'],
            url: '',
            repo: '',
        ...
        },
        {
            ...
            year: '2026',
            status: 'live',
            blurb: 'One-input expense tracker — type "12.50 coffee", press Enter, done.',
            outcome: 'Logs an expense in under 3 seconds with zero ceremony: no accounts, no forms, offline forever.',
            desc: 'I built Moneyline because every finance app I tried needed three screens to log one coffee. It is one input with a Vim-inspired grammar — amounts, arithmetic, dates, categories and flags in any order — plus a single honest number, SAFE TODAY, that previews the consequence of what you are typing before you commit. Integer-cents ledger, transactional writes, plain-text backup and restore, Ethiopian calendar with ETB primary and USD conversion. No framework, no build step, no telemetry; the phone is the database.',
            stack: ['javascript', 'capacitor', 'indexeddb', 'pwa'],
            url: '',
            repo: '',
            sourceNote: 'private — ask me',
            highlights: [
                'one-input grammar with live SAFE TODAY preview while typing',
                'integer-cents ledger: transactional writes, quarantine, plain-text export/import/restore',
                'Ethiopian calendar, ETB-first with USD rates — fully offline',
                '138 unit tests + 34 Playwright E2E, zero console errors',
            ],
        },
